...
const strategyName = "Morpho_Moonwell_Flagship_ETH";
...
const func: DeployFunction = async function () {
  ...
  await deployAndConfigureStrategy({
    ...
    proxy: {
      initializeArgs: [Address.Vesper.vaETH, Address.swapper, Address.Morpho.vault.Moonwell_Flagship_ETH, strategyName],
    },
  });
};
