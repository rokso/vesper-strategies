...
import {SWAPPER, vaETH, vaUSDC, rewards, COMP, cUSDCv3, cWETHv3} from "test/helpers/Address.ethereum.sol";
...
contract CompoundV3_Ethereum_USDC_Test is CompoundV3_Test {
    function _setUp() internal override {
        ...
        strategy = new CompoundV3();
        deinitialize(address(strategy));
        CompoundV3(address(strategy)).initialize(vaUSDC, SWAPPER, rewards, COMP, cUSDCv3, "");
    }
}
