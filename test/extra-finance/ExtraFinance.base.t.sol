...
contract ExtraFinance_Pool1_ETH_Base_Test is ExtraFinance_Test {
...
contract ExtraFinance_Pool1_USDC_Base_Test is ExtraFinance_Test {
    function _setUp() internal override {
        super.createSelectFork("base");
...
contract ExtraFinance_Pool2_USDC_Base_Test is ExtraFinance_Test {
    function _setUp() internal override {
        super.createSelectFork("base");
